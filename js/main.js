$(window).load(function() {
    ...
    (function() {
        ...
        MESSAGES.push({
            delay: 800,
            text: ' —  Code fanatic / Full Stack Developer and Designer;'
        });
        MESSAGES.push({
            delay: 1800,
            text: ' —  Audio and Video Analyst & Producer;'
        });
        MESSAGES.push({
            delay: 3200,
            text: ' —  Expert(ReactJS, NodeJS, Gatsby, MongoDB, GraphQL,UI/UX Designing ).'
        });
        MESSAGES.push({
            delay: 3200,
            text: ' —   Love Telegram more than Whatsapp'
        });
        MESSAGES.push({
            delay: 4800,
            text: ' '
